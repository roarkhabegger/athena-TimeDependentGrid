...
namespace HydroIntegratorTaskNames {
  ...
  const uint128_t SEND_HYDSH=1LL<<46;
  const uint128_t SEND_EMFSH=1LL<<47;
  const uint128_t SEND_FLDSH=1LL<<48;
  const uint128_t RECV_HYDSH=1LL<<49;
  const uint128_t RECV_EMFSH=1LL<<50;
  const uint128_t RECV_FLDSH=1LL<<51;
  const uint128_t RMAP_EMFSH=1LL<<52;

  const uint128_t DIFFUSE_HYD=1LL<<53;
